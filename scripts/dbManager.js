var DbManager = function()
{
    ...
    this.itemsDb = 
    [
        {name : 'R.E.M. - Losing My Religion', totalScore : 6, scoreList : [{user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "4 Non Blondes - What's Up", totalScore : 2, scoreList : [{user : 'Henrique', score : 1}, {user : 'Dodô', score : 1}, {user : 'Matheus', score : 0}]},
        {name : "The Cure - Boys Don't Cry", totalScore : 6, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 0}, {user : 'Matheus', score : 3}]},
        ...
        {name : "Pink Floyd - Another Brick In The Wall", totalScore : 7, scoreList : [{user : 'Henrique', score : 1}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "The White Stripes - Seven Nation Army", totalScore : 6, scoreList : [{user : 'Henrique', score : 0}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        ...
        {name : "Radiohead - Creep", totalScore : 7, scoreList : [{user : 'Henrique', score : 1}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "RHCP - Parallel Universe", totalScore : 7, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 1}]},
        {name : "RHCP - Californication", totalScore : 9, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        ...
        {name : "Foo Fighters - My Hero", totalScore : 6, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 0}, {user : 'Matheus', score : 3}]},
        {name : "Pearl Jam - Alive", totalScore : 9, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "Pearl Jam - Black", totalScore : 6, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 0}, {user : 'Matheus', score : 3}]},
        {name : "Audioslave - Like A Stone", totalScore : 7, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 1}, {user : 'Matheus', score : 3}]},
        {name : "QOTSA - Go With The Flow", totalScore : 9, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "Deep Purple - Smoke On The Water", totalScore : 5, scoreList : [{user : 'Henrique', score : 1}, {user : 'Dodô', score : 1}, {user : 'Matheus', score : 3}]},
        {name : "Metallica - Nothing Else Matters", totalScore : 7, scoreList : [{user : 'Henrique', score : 1}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
        {name : "Metallica - Whiskey In The Jar", totalScore : 6, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 0}, {user : 'Matheus', score : 3}]},
        {name : "Linkin Park - In The End", totalScore : 9, scoreList : [{user : 'Henrique', score : 3}, {user : 'Dodô', score : 3}, {user : 'Matheus', score : 3}]},
